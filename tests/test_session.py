...
def _isolate(monkeypatch):
    ...
    """
    import intelligence.orchestrator.session as _sess
...
class TestCreateLoad:
    def test_create_returns_session_dict(self):
        from intelligence.orchestrator.session import create_session
        s = create_session()
    ...
    def test_load_session_returns_dict(self):
        from intelligence.orchestrator.session import create_session, load_session
        s = create_session()
    ...
    def test_load_missing_session_returns_none(self):
        from intelligence.orchestrator.session import load_session
        assert load_session("nonexistent-id") is None

    def test_load_current_session(self):
        from intelligence.orchestrator.session import create_session, load_current_session
        s = create_session()
    ...
    def test_load_current_session_when_none_exists(self):
        from intelligence.orchestrator.session import load_current_session
...
class TestFindSession:
    def test_exact_id_match(self):
        from intelligence.orchestrator.session import create_session, find_session
        s = create_session()
    ...
    def test_nonexistent_prefix_returns_none(self):
        from intelligence.orchestrator.session import find_session
...
class TestAppendExchange:
    def test_append_adds_two_messages(self):
        from intelligence.orchestrator.session import create_session, append_exchange
        s = create_session()
    ...
    def test_append_persists_to_disk(self):
        import intelligence.orchestrator.session as _sess
        from intelligence.orchestrator.session import create_session, append_exchange, load_session
        s = create_session()
...
class TestListSessions:
    def test_empty_when_no_sessions(self):
        from intelligence.orchestrator.session import list_sessions
        assert not list_sessions()

    def test_returns_created_sessions(self):
        from intelligence.orchestrator.session import create_session, list_sessions
        create_session()
        create_session()
    ...
    def test_sorted_newest_first(self):
        ...
        import time
        from intelligence.orchestrator.session import create_session, list_sessions, append_exchange
        s1 = create_session()
    ...
    def test_current_session_pointer(self):
        from intelligence.orchestrator.session import create_session, current_session_id
        s1 = create_session()
...
class TestAdapterHistory:
    ...
    def test_gemini_history_converts_assistant_to_model(self):
        from intelligence.orchestrator.model_adapters.gemini_adapter import _build_contents
